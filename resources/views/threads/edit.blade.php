...
@section('content')
    <div class="container" id="main">
        <div class="content-form">
            <h2><i class="fa fa-plus"></i> Edit group chat</h2>

            {!! Form::open(['url' => route('threads.update', $thread), 'method'=>'patch', 'files' => true, 'enctype' => 'multipart/form-data', 'id' => 'threads-form']) !!}
