...
return [
    ...
    */
    ...
    'job'                   => 'Наименование',
    'status'                => 'Статус',        
    'nojobs'                => 'Текущих заданий нет.',
    'noBookmarks'           => 'В закладках пусто',    
    'freelancer'            => 'Я исполнитель',
    'client'                => 'Я заказчик',
    'menu'                  => 'Разделы',
    'task-created'          => 'Заданий создано:',
    'task-completed'        => 'Заданий выполнено:',
    'first-deadline'        => 'Ближайшее задание которое необходимо выполнить:',
    'deadline-time'         => 'Срок:',               
